...
import { R as redirect, _ as createRootRoute, b as useRouter, d as HeadContent, g as createFileRoute, h as lazyRouteComponent, m as Outlet, p as createRouter, u as Scripts } from "../_libs/@tanstack/react-router+[...].mjs";
...
import { n as auth } from "./server-BjmXTM3N.mjs";
...
var Route$7 = createRootRoute({
	...
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Throw a kiss at someone. That's the whole app."
			},
			{
				name: "theme-color",
				content: "#070707"
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(QueryClientProvider, {
					client: queryClient,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outlet, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, { position: "top-center" })]
				}) }),
...
var Route$6 = createFileRoute("/")({
	...
	validateSearch: (s) => ({
		k: typeof s.k === "string" ? s.k : void 0,
		p: typeof s.p === "string" ? s.p : void 0
	})
});
var $$splitComponentImporter$4 = () => import("./friends-B4hHEXZK.mjs");
var Route$5 = createFileRoute("/friends")({
	beforeLoad: () => {
		throw redirect({ to: "/" });
	},
	component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
var $$splitComponentImporter$3 = () => import("./inbox-DKVWidGI.mjs");
var Route$4 = createFileRoute("/inbox")({
	beforeLoad: () => {
		throw redirect({ to: "/" });
	},
...
var $$splitComponentImporter$1 = () => import("./profile-h_-gtumx.mjs");
...
var Route$1 = createFileRoute("/k/$from")({
	...
	head: ({ params }) => {
		...
		return { meta: [
			...
			{
				name: "description",
				content: "Open it. Catch the kiss."
			},
			{
				property: "og:title",
				content: `${who} kissed you`
			},
			{
				property: "og:description",
				content: "A kiss just landed. Open it."
			}
		] };
	}
});
...
var rootRouteChildren = {
	...
	FriendsRoute: Route$5.update({
		id: "/friends",
		path: "/friends",
		getParentRoute: () => Route$7
	}),
	InboxRoute: Route$4.update({
		id: "/inbox",
		path: "/inbox",
		getParentRoute: () => Route$7
	}),
...
//#endregion
export { createSsrRpc as i, Route$1 as n, queryClient as r, router_exports as t };
